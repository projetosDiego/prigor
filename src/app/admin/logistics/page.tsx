        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-stone-500 font-medium">
              Gestão de entregas, conferência de carga/expedição antes de ir pra rua e romaneio de saída
            </p>
          </div>
                      ...
                      <div key={p.id} className="relative">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {checkedOrderIds.includes(p.id) && (
                            <span className="inline-flex items-center px-1 py-0.2 rounded text-[8px] font-black bg-emerald-100 text-emerald-800">
                              ✓ Conferido
                            </span>
                          )}
                        </div>
                        ...
                        <div className="flex gap-2.5 mt-1 text-[10px] font-bold text-amber-700">
                          <a
          ...
          <div className="space-y-5 animate-fadeIn">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
              <div className="rounded-2xl bg-white p-4 border border-stone-200 shadow-xs">
                ...
                <span className="text-[10px] text-stone-500 font-medium">agendados para {formatarData(selectedDate)}</span>
              </div>
            ...
            {totalPedidosChecklist > 0 && (
              pendentes.length > 0 ? (
                ...
                <div className="rounded-2xl border border-emerald-300 bg-emerald-50 p-4 flex items-center justify-between gap-3 shadow-xs">
                  ...
                  <button
                    type="button"
                    onClick={() => window.print()}
                    className="shrink-0 px-4 py-2 rounded-lg bg-emerald-800 hover:bg-emerald-900 text-white text-xs font-black cursor-pointer transition-all flex items-center gap-1.5 shadow-2xs"
                  >
                    <Printer className="h-4 w-4" />
                    Imprimir Romaneio Assinado
                  </button>
                </div>
              )
            )}
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-stone-100 pb-3">
                        ...
                        {/* Informações de Contato e Financeiro */}
